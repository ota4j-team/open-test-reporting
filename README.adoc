...
[source,xml]
----
include::schema/src/docs/asciidoc/includes/events.xml[]
----
...
[source,xml]
----
include::schema/src/docs/asciidoc/includes/hierarchy.xml[]
----
...
[source,java]
----
include::events/src/test/java/DocumentWriterSample.java[]
----
