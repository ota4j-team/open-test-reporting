= Open Test Reporting
:schemaVersion: 0.2.0
:openTestReportingVersion: 0.2.0-M1
...
You can download the CLI tool from Maven Central using the https://repo1.maven.org/maven2/org/opentest4j/reporting/open-test-reporting-cli/{openTestReportingVersion}/open-test-reporting-cli-{openTestReportingVersion}-standalone.jar[`org.opentest4j.reporting:open-test-reporting:{openTestReportingVersion}-cli:standalone`] coordinates.
